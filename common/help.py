...
COMMANDS = [
    ...
    {"cat": "유저", "key": "등록", "sig": "/등록",
     "desc": "관리자가 준 토큰으로 역할에 가입합니다.",
     "ex": "/등록 → 버튼 → 토큰 입력", "admin": False},
    ...
    {"cat": "역할", "key": "역할 부여", "sig": "/역할 부여 <역할> <id> <boj>",
     "desc": "특정 사용자에게 역할을 수동 부여하고 BOJ 핸들을 등록합니다.",
     "ex": "/역할 부여 21기-심화 @유완규 beans3142", "admin": True},

...
COMMANDS = [
    ...
    {"cat": "역할", "key": "역할 제거", "sig": "/역할 제거",
     "desc": "역할+사용자 드롭다운으로 멤버를 제거합니다.", "admin": True},
    {"cat": "역할", "key": "역할 제거디스코드", "sig": "/역할 제거디스코드",
     "desc": "역할+사용자 드롭다운으로 멤버를 제거합니다. (제거와 동일)", "admin": True},
    {"cat": "역할", "key": "역할 멤버", "sig": "/역할 멤버",
     "desc": "역할 멤버 목록과 서버 내/외 상태를 봅니다. (최대 25명)", "admin": True},
    {"cat": "역할", "key": "역할 삭제", "sig": "/역할 삭제",
     "desc": "역할과 등록 정보·토큰을 모두 삭제합니다.", "admin": True},
    {"cat": "역할", "key": "역할 문제풀이현황", "sig": "/역할 문제풀이현황",
    ...
    {"cat": "역할", "key": "역할 주간현황설정", "sig": "/역할 주간현황설정",
    ...
    {"cat": "그룹", "key": "그룹 수정", "sig": "/그룹 수정",
     "desc": "그룹(카테고리) 이름을 바꿉니다.", "admin": True},
    {"cat": "그룹", "key": "그룹 삭제", "sig": "/그룹 삭제",
    ...
    {"cat": "과제", "key": "그룹 주간현황삭제", "sig": "/그룹 주간현황삭제",
    ...
    {"cat": "문제집·테스트", "key": "주간테스트", "sig": "/주간테스트 <소스>",
     "desc": "CF 대회 1개로 ①통과(2문제↑, 방식 무관) + ②랭킹(가상참가 ICPC: 문제수·페널티) 보드를 만듭니다.",
     "ex": "/주간테스트 https://codeforces.com/contest/2000",
     "note": "소스=CF 대회링크·노션링크·contestId. 랭킹은 가상참가(virtual)만. 월 00시 결산.", "admin": True},
